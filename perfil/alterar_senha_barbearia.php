<?php
/**
 * Processamento da alteração de senha da barbearia
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        ...
        $sucesso = $perfil->alterarSenhaBarbearia($id_barbearia, $senha_atual, $nova_senha);
    ...
    header('Location: ../perfil_barbearia.php?tab=senha');
    exit;
} else {
