...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sucesso = $agendamentos->atualizarStatus($id_agendamento, 'confirmado', $id_barbearia, 'barbearia');
    
    if ($sucesso) {
        $_SESSION['agendamentos_mensagem'] = 'Agendamento confirmado com sucesso!';
        $_SESSION['agendamentos_status'] = 'success';
    } else {
        $_SESSION['agendamentos_mensagem'] = 'Erro ao confirmar o agendamento.';
